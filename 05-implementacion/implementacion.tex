...
Configurando el protocolo de recolección (Workflow en Samplers) y unos parámetros más, con Samplers se puede generar una aplicación lista para ejecutarse en un dispositivo móvil Android. Esta aplicación generada sirve para tomar muestras siguiendo el protocolo de recolección especificado, y las almacena en el dispositivo móvil hasta que puedan ser enviadas a un servidor web previamente configurado.

Por ejemplo, si se desea crear una aplicación para...
...
\subsubsection{Usando las clases}
...
TakeSampleActivity es una Activity para tomar la muestra/ "encargada de tomar la muestra". (Agregar al titulo)
