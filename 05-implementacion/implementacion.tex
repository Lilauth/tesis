...
En el objeto application, se encuentran los parámetros para configurar a la app, como por ejemplo el mensaje de bienvenida o el servidor web al que se deben enviar las muestras recolectadas. Los parámetros son los siguientes:
\begin{itemize}
...
[Aca explicaremos cómo sería usando las clases en una app existente por ejemplo, pero sencillo y por arriba porque todavia no se explicaron las clases en detalle que viene en la siguiente sección].
