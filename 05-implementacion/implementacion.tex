...
Las muestras se guardan en el dispositivo móvil en un archivo JSON, junto con los archivos multimedia que pudiera tener, dentro de un directorio por cada muestra.
Para pasar a JSON se us gson.
...
Para comprimir usamos las librerias de java.util
Se envían automáticamente cuando detecta conexión wi-fi o a petición del usuario.
