...
Para representar éste protocolo de recolección se debería configurar el archivo de configuración para Samplers de la siguiente manera: 
...
Las opciones disponibles y cómo se configura el archivo de configuración de Samplers se explican en la siguiente sección.
...
\section{Usando las clases}

Como sería usando las clases en una app existente por ejemplo.
