...
El detalle de estos Steps y su funcionamiento se explican en la sección \ref{sec:instalacion_uso}.
...
\subsection{Toma de la Muestra: TakeSampleActivity}
...
Revisar si comprime el archivo zip (el txt en realidad): SI COMPRIME

Ver si van los archivos sueltos o va el directorio dentro del zip: LOS ARCHIVOS SUELTOS
