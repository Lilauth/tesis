...
esta asociado a un StepFragment (debe conocerlo...)
...
\subsubsection{StepFragment: la vista del Step}
...
Cada ejecución de un mismo Step, puede generar un StepResult diferente.

Un StepResult tiene el Id del Step en base al cual se generó. 

También puede tener asociado un archivo multimedia.
...
Revisar si comprime el archivo zip (el txt en realidad)

Ver si van los archivos sueltos o va el directorio dentro del zip
