...
\subsection{Otros componentes de la app generada por Samplers}
[acá vamos a hablar de las otras Activities que se crean cuando se genera una app con Samplers]
