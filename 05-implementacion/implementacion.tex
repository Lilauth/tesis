...
Brinda una solución simple al problema de la recolección de la muestra .
...
## en un principio se pensó para que un científico pudiera crear su propia app sin tener conocimientos de programación
