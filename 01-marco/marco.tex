...
\section{Introducción a la Ciencia Ciudadana}
	...
	Algunos de estos proyectos cuentan con una larga historia de investigación (como el CBC, Christmas Bird Count), otros con gran cantidad de participantes, quienes interactúan a través de foros y aplicaciones web desde la comodidad de sus hogares, como sucede en proyectos como Zooniverse donde los participantes señalan en fotografías que ven en el sitio la ocurrencia o no de determinado animal; o bien abarcando grandes extensiones geográficas, como puede ser en The Big Butterfly Count, donde los participantes cuentan la cantidad de mariposas que ven en su propio patio o en un parque. \cite{shirk2012public} 
