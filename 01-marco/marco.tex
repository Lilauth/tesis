...
\begin{itemize}
	...
	La escuela pragmática se enfocan en lograr que el proceso de investigación sea más eficiente. Considera a la investigación científica como un proceso que puede ser optimizado modularizando, abriendo la ``cadena de producción'', incorporando conocimiento externo, permitiendo la colaboración a través de internet. Con las herramientas de internet el proceso de investigación puede hacerse colaborativo y aprovechar el conocimiento de las masas
