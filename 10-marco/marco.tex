...
\begin{itemize}
	...
	La Escuela Pública se procupa por hacer que la ciencia sea accesible al público. Propone que la ciencia debe estar disponible para una audiencia mayor de interesados. Con las herramientas sociales de la web los investigadores pueden hacer público el proceso de investigación y preparar los resultados de su investigación para los interesados, no necesariamentes expertos en el área. Hay dos corrientes: una comprometida con el proceso de investigación (la producción) y otra con los resultados (el producto).
